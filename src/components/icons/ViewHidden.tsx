...
export const IconViewHidden: FC<SVGProps<SVGSVGElement>> = ({ className = '', ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      className={`icon-view-hidden ${className}`}
      fill="currentcolor"
      {...rest}
    >
      <path
      ...
      />
      <path className="secondary" d="M3.3 4.7l16 16a1 1 0 0 0 1.4-1.4l-16-16a1 1 0 0 0-1.4 1.4z" />
    </svg>
  )
}
